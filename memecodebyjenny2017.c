...
task pidController()
{
	...
	while(true)
	{
		...
		if(pidActive)
		{
			...
			// DRIVE BOI DRIVE
			motor[l_frontDrive] = (int)((float)pidDriveLeft * (-1.0)*leftDriveScale);
			motor[l_backDrive] = (int)((float)pidDriveLeft * (-1.0)*leftDriveScale);
			motor[r_frontDrive] = (int)((float)pidDriveRight * rightDriveScale);
			motor[r_backDrive] = (int)((float)pidDriveRight * rightDriveScale);
		}
		else // delete the emails, i mean variables
		{
			...
			pidDriveLeft= 0;
			pidDriveRight = 0;
			motor[l_frontDrive] = 0;
			motor[l_backDrive] = 0;
			motor[r_frontDrive] = 0;
			motor[r_backDrive] = 0;
		}
